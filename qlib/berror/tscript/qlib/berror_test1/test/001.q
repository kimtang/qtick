...
.qtx.testSuite[`test.berror_test.berror_test1;"test berror_test1"]
  .qtx.repo[`berror_test]
  .qtx.lib[`berror_test1]
  ...
  .qtx.testCase[`test.berror_test1.1;"test berror_test1"][
